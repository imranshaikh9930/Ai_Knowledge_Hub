...
export default function Register() {
  ...
  return (
    // <div classNameName="flex min-h-screen items-center justify-center bg-gray-100 px-4">
    //   <form 
    //     onSubmit={submit} 
    //     classNameName="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg"
    //   >
    //     <h2 classNameName="text-2xl font-bold text-center mb-6 text-gray-800">
    //       Create Account
    //     </h2>
    ...
    //         placeholder="Name"
    //         classNameName="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
    //       />
    //     </div>
    ...
    //     <button
    //       type="submit"
    //       classNameName="w-full bg-blue-600 text-white py-2 rounded-lg font-semibold hover:bg-blue-700 transition duration-300"
    //     >
    //       Register
    //     </button>

    //     {/* Already have an account */}
    //     <p classNameName="mt-4 text-center text-gray-600">
    //       Already have an account?{" "}
...
<div className="w-full max-w-full md:w-[500px] px-3 mx-auto mt-0 md:flex-0 shrink-0">
  <div className="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
    ...
    <div className="flex-auto p-6">
      <form role="form text-left" onSubmit={submit}>
        <div className="mb-4">
          <input aria-describedby="email-addon" aria-label="Name" placeholder="Name" className="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" type="text" value={name} onChange={(e)=> setName(e.target.value)}/>
        </div>
        <div className="mb-4">
  ...
  <label for="terms" className="mb-2 ml-1 font-normal cursor-pointer select-none text-sm text-slate-700"> I agree the <a className="font-bold text-slate-700">Terms and Conditions</a>
    <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 inline ml-1 fill-current text-green-500">
      <path d="M6.293 9.293a1 1 0 0 1 1.414 0L10 10.586l2.293-2.293a1 1 0 1 1 1.414 1.414l-3 3a1 1 0 0 1-1.414 0l-3-3a1 1 0 0 1 0-1.414z"></path>
        ...
        <p className="mt-4 mb-0 leading-normal text-sm">Already have an account? <Link to="/login" className="font-bold text-slate-700" href="../pages/sign-in.html">Sign in</Link></p>
      </form>
    </div>
  </div>
</div>
